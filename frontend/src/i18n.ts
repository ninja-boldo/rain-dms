...
const en = {
  ...
  main_loadedOf: (n: number, total: number) => `${n} of ${total} loaded — scroll for more`,
  ...
  st_accentCustomHint: "Pick any colour — the rest of the palette is derived automatically.",
  ...
  st_decrypt: "Client-side decryption",
  st_decryptSub: "Decrypt files and banner images in-browser using your password-derived key",
  st_mainKey: "Main encryption key",
  st_mainKeyOk: (prefix: string, n: number) =>
    `${prefix}… (${n} chars) — unlocked ✓`,
  st_mainKeyNone: "Not available — sign in again to derive from password",
  st_account: "Account",
  st_signedIn: "Signed in as",
  st_jwt: "JWT stored in localStorage",
  st_about: "About",
  st_stack: "Stack",
  st_stackSub: "Bun · Hono · SeaweedFS · RabbitMQ · PaddleOCR · Meilisearch",
  st_ocrFormat: "OCR format",
  st_ocrFormatSub: "upLeftPoint / downRightPoint bounding boxes · PP-OCRv5",
  st_uploadFilters: "Upload filters",
  st_allowedExt: "Allowed file extensions",
  st_allowedExtSub: "Only files with these extensions will be accepted. One per line (with dot). Clear to disable filter.",
  ...
  fs_noMarkers: "No markers yet. Open the document, switch to ✎ Mark mode, double-click an OCR box or drag a rectangle to create one.",
  fs_drawn: "drawn",
  fs_ocr: "ocr",
...
const de: typeof en = {
  ...
  sr_noResultsHint: "Versuche eine kürzere oder allgemeinere Suche, oder entferne den Datumsfilter.",
  sr_results: (hits: number, distinct: number) =>
  ...
  main_loadedOf: (n: number, total: number) => `${n} von ${total} geladen — scrollen für mehr`,
  ...
  doc_size: "Größe",
  doc_markModeHint: "Ziehe ein Rechteck auf einer Seite, um eine Markierung zu erstellen",
  doc_markModeHint2: "Wechsle in den Zeichenmodus, um eine Markierung zu erstellen",
  ...
  st_accentCustomHint: "Wähle eine beliebige Farbe — der Rest der Palette wird automatisch abgeleitet.",
  ...
  st_remindersEmpty: "Keine Erinnerungen gesetzt. Öffne die Info-Seite einer Datei, um eine anzulegen.",
  ...
  st_decrypt: "Client-seitige Entschlüsselung",
  st_decryptSub: "Dateien und Banner im Browser entschlüsseln (passwortbasierter Schlüssel)",
  st_mainKey: "Hauptverschlüsselungsschlüssel",
  st_mainKeyOk: (prefix: string, n: number) =>
    `${prefix}… (${n} Zeichen) — entsperrt ✓`,
  st_mainKeyNone: "Nicht verfügbar — bitte erneut anmelden",
  st_account: "Konto",
  st_signedIn: "Angemeldet als",
  st_jwt: "JWT im localStorage",
  st_about: "Über",
  st_stack: "Stack",
  st_stackSub: "Bun · Hono · SeaweedFS · RabbitMQ · PaddleOCR · Meilisearch",
  st_ocrFormat: "OCR-Format",
  st_ocrFormatSub: "upLeftPoint / downRightPoint Bounding-Boxen · PP-OCRv5",
  st_uploadFilters: "Upload-Filter",
  st_allowedExt: "Erlaubte Dateiendungen",
  st_allowedExtSub: "Nur Dateien mit diesen Endungen werden akzeptiert. Eine pro Zeile (mit Punkt). Leeren deaktiviert den Filter.",
  ...
  lg_working: "Lädt…",
  lg_sessionExpired: "Deine Sitzung ist abgelaufen. Bitte melde dich erneut an.",
  ...
  fs_noMarkers: "Noch keine Markierungen. Öffne das Dokument, wechsle in den ✎ Markieren-Modus, doppelklicke eine OCR-Box oder ziehe ein Rechteck.",
  fs_drawn: "gezeichnet",
  fs_ocr: "ocr",
  ...
  err_delete: (n: number) => `${n} Datei${n !== 1 ? "en" : ""} konnte${n !== 1 ? "n" : ""} nicht gelöscht werden`,
